...
class WeddingPressV3_Plugin {
	...
	public function license_field() {
		...
		<?php if ( isset( $license_status->license ) && ( $license_status->license == 'valid' || $license_status->license == 'expired' || $license_status->license == 'no_activations_left' || $license_status->license == 'inactive' ) ) : ?>
			...
			<input name="weddingpress_license_hidden" type="hidden"  id="weddingpress_license_hidden" type="text" style="min-width:280px;" value="<?php echo $this->get_hidden_license( $license ); ?>" class="" placeholder="" disabled> <input name="wdp_elementor_deactivate" type="hidden"  class="button button-secondary" type="submit" value="Deactivate">
		...
		<?php else : ?>
			<input name="weddingpress_license" hidden id="weddingpress_license" type="text" style="max-width:280px;" value="<?php echo $license; ?>" class="regular-text code" placeholder="masukkan kode licensi di sini"> <input name="wdp_elementor_activate" class="button button-primary" hidden type="submit" value="Activate">
	...
	public function check_license() {
		...
		$response = json_encode(array(
		    ...
		    "license"=>"valid",
		    "item_id"=>false,
		    //php versi 7 pakai source code yang di bawah ini
		    //"item_name"=>$this->item_name,
		    //php versi 8 pakai source code yang di bawah ini
		    "item_name"=>"item_name",
		    "error"=>"",
		    "license_limit"=>0,
		    "site_count"=>'9999',
